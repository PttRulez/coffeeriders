...
<template>
    ...
    <ul>
        ...
        <li>
            ...
            — универсальные и комфортные для поездок по смешанным покрытиям, вело прогулок и путешествий;
        </li>
        <li>
            <strong>
    ...
    <p>
        <strong>Все велосипеды отобраны действующими спортсменами</strong> — мастерами спорта и основателями нашей вело команды. Мы доверяем им сами и
