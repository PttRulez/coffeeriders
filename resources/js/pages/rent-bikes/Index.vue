...
<template>
    ...
    <section class="space-y-5 break-words!">
        ...
        <div>
            ...
            <p>
                Мы заботимся о том, чтобы ваша поездка была безопасной и комфортной.
            </p>
        </div>

        <p>
            Также вы можете <strong>взять в аренду шлем</strong> — 400 рублей в день
        </p>
    </section>
</template>
